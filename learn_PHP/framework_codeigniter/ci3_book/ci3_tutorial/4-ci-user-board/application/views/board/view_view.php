		...
		<tfoot>
			<tr>
				<th colspan="4">
					...
					<a href="/board/modify/<?= $this->uri->segment(3) ?>" class="btn btn-primary ml-1">게시글 수정</a>
					<a href="/board/delete/<?= $this->uri->segment(3) ?>" class="btn btn-outline-danger float-right">글 삭제</a>
					<?php else: ?>
