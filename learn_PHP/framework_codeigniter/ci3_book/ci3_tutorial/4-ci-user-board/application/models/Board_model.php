...
class Board_model extends CI_Model {
	 ...
	 * 게시물 추가
	 *
	 * @param array $arrays 테이블명, 게시물 제목, 게시물 내용, 작성자 이름 1차 배열
	...
	function writer_check($table, $board_id) {
		$sql = "SELECT username FROM $table WHERE board_id='$board_id'";
		$query = $this->db->query($sql);
	 ...
	 * 댓글 입력
	 *
	 * @param array $arrays 테이블명, 게시물 제목, 게시물 내용, 작성자명 1차 배열
	 * @return boolean 입력 성공여부
	 */
